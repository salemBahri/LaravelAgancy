                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="example-input-large" name="institution"
                                        class="form-control form-control-lg" placeholder="Institution Name" required>
                                </div>
                                <div class="mb-3">
                                    <label for="floatingInput">Field Of Study</label>
                                    <input type="text" id="example-input-large" name="field_of_study"
                                        class="form-control form-control-lg" placeholder="Field Of Study" required>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="floatingInput">End Date</label>
                                    <input type="date" name="end_date" class="form-control date form-control-lg" id="endDateEducation" data-single-date-picker="true" required >
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="example-input-large" name="degree"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control date form-control-lg" id="startDateEducation" type="date" name="start_date" data-single-date-picker="true" required="">

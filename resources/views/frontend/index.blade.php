...
<head>
    ...
    <!-- CSS Files
    ================================================== -->
    <link href="{{asset('frontend/assets/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" id="bootstrap">
    ...
    <link href="{{asset('frontend/assets/css/coloring.css')}}" rel="stylesheet" type="text/css" >
    <!-- color scheme -->
    <link id="colors" href="{{asset('frontend/assets/css/colors/scheme-01.css')}}" rel="stylesheet" type="text/css" >
...
<body class="dark-scheme">
                    ...
                    <div class="row g-5">
                        <div class="col-lg-4  wow fadeInRight" data-wow-delay=".3s">
                            <div class="p-3 h-100 d-lg-block d-sm-none text-light jarallax">
                                <img src="{{asset('frontend/assets/images/misc/2.webp')}}" class="jarallax-img" alt="">
                        ...
                        <div class="col-lg-4">
                            <div class="hover relative overflow-hidden text-light">  
                              <a href="work-single.html" class="overflow-hidden d-block relative">
                                ...
                                <img src="{{asset('frontend/assets/images/works/1.webp')}}" class="img-fluid hover-scale-1-2" alt="">
                        ...
                        <div class="col-lg-4">
                            <div class="hover relative overflow-hidden text-light">  
                              <a href="work-single.html" class="overflow-hidden d-block relative">
                                ...
                                <img src="{{asset('frontend/assets/images/works/2.webp')}}" class="img-fluid hover-scale-1-2" alt="">
                        ...
                        <div class="col-lg-4">
                            <div class="hover relative overflow-hidden text-light">  
                              <a href="work-single.html" class="overflow-hidden d-block relative">
                                ...
                                <img src="{{asset('frontend/assets/images/works/3.webp')}}" class="img-fluid hover-scale-1-2" alt="">
                                        ...
                                        <div class="row g-4 align-items-center">
                                            <div class="col-sm-3">
                                                <div class="post-image">
                                                    <img alt="" src="{{asset('frontend/assets/images/blog/1.webp')}}" class="lazy">
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="relative">
                                        <div class="row g-4 align-items-center">
                                            <div class="col-sm-3">
                                                <div class="post-image">
                                                    <img alt="" src="{{asset('frontend/assets/images/blog/2.webp')}}" class="lazy">
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="relative">
                                        <div class="row g-4 align-items-center">
                                            <div class="col-sm-3">
                                                <div class="post-image">
                                                    <img alt="" src="{{asset('frontend/assets/images/blog/3.webp')}}" class="lazy">
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="relative">
                                        <div class="row g-4 align-items-center">
                                            <div class="col-sm-3">
                                                <div class="post-image">
                                                    <img alt="" src="{{asset('frontend/assets/images/blog/4.webp')}}" class="lazy">
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="relative">
                                        <div class="row g-4 align-items-center">
                                            <div class="col-sm-3">
                                                <div class="post-image">
                                                    <img alt="" src="{{asset('frontend/assets/images/blog/5.webp')}}" class="lazy">
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="relative">
                                        <div class="row g-4 align-items-center">
                                            <div class="col-sm-3">
                                                <div class="post-image">
                                                    <img alt="" src="{{asset('frontend/assets/images/blog/6.webp')}}" class="lazy">
                                                </div>
                                            </div>
    ...
    <script src="{{asset('frontend/assets/js/custom-marquee.js')}}"></script>
